      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-white">
        ...
        >
          ...
          <div className="mb-6">
            ...
            <div className="w-44 movile:w-auto movile:flex movile:justify-center movile:space-x-4 movile:items-baseline">
              <motion.button
                name="userType"
                ...
                className={`px-4 py-2 mb-1 text-sm movile:text-base rounded-full transition-colors duration-300 ${
              ...
              <motion.button
                ...
                className={`px-4 py-2 mt-1 text-sm movile:text-base rounded-full transition-colors duration-300 ${
                  userType === "admin"
                    ? "bg-blue-600 text-white"
                    : "bg-gray-100 text-gray-800 hover:bg-gray-200"
                }`}
